import { getColorWithKeyCss } from './getColorWithKeyCss.js';
import { mergeDeep } from './mergeDeep.js';
import 'deepmerge';

const colorHandler = (props, isAction = true) => {
  const textColorHover = mergeDeep(props.$textColor?.variant, props.$textColor?.hover),
  ...
  &:not(:disabled){
    ${textColorActive || props.$textColor?.variant ? getColorWithKeyCss({
    name: "color",
    color: props.$isActive ? textColorActive : props.$textColor?.variant,
    props
  }) : ""}
   
    ${bgColorActive || props.$bgColor?.variant ? getColorWithKeyCss({
    name: "background-color",
    color: props.$isActive ? bgColorActive : props.$bgColor?.variant,
    props
  }) : "background-color : transparent;"}
    ${borderColor || borderColorActive ? getColorWithKeyCss({
    name: "border-color",
    ...
    &:hover{
      ${textColorHover ? getColorWithKeyCss({
    name: "color",
    color: textColorHover,
    props
  }) : ""}
      ${bgColorHover ? getColorWithKeyCss({
    name: "background-color",
    color: bgColorHover,
    props
  }) : ""}
      ${borderColorHover ? getColorWithKeyCss({
    name: "border-color",
    ...
    &:active{
      ${textColorActive ? getColorWithKeyCss({
    name: "color",
    color: textColorActive,
    props
  }) : ""}
      ${bgColorActive ? getColorWithKeyCss({
    name: "background-color",
    color: bgColorActive,
    props
  }) : ""}
      ${borderColorActive ? getColorWithKeyCss({
    name: "border-color",
